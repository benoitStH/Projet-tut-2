...
ObjectsFileList        :="projettut2.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/instance.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/instance.c$(PreprocessSuffix): instance.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/instance.c$(PreprocessSuffix) instance.c
